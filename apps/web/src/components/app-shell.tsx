...
const navByRole: Record<Role, Array<{ href: string; label: string; icon: React.ElementType }>> = {
  STUDENT: [
    ...
    { href: "/student/skillproof", label: "SkillProof AI", icon: Sparkles },
    { href: "/student/github-analysis", label: "GitHub Analysis", icon: Github },
    { href: "/student/leetcode-analysis", label: "LeetCode Analysis", icon: Code2 },
    { href: "/student/hackerrank-analysis", label: "HackerRank Proof", icon: Medal },
    { href: "/student/resume-analysis", label: "Resume AI", icon: FileText },
    { href: "/student/company-fit", label: "Company Fit", icon: Target },
    { href: "/student/roadmap", label: "Roadmap", icon: Route },
    { href: "/student/skill-verification", label: "Skill Verification", icon: BrainCircuit },
  ...
  TPO_ADMIN: [
    ...
    { href: "/tpo/top-students", label: "Top Students", icon: Sparkles },
    { href: "/tpo/skill-gap-report", label: "Skill Gaps", icon: BrainCircuit },
    { href: "/tpo/drive-recommendations", label: "Drive Recommendations", icon: Target },
    { href: "/tpo/company-fit-report", label: "Company Fit Report", icon: BarChart3 },
    { href: "/tpo/weak-skills-report", label: "Weak Skills", icon: Gauge },
